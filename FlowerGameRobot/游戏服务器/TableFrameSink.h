...
//变量定义////////////
private:
	static BYTE						m_cbTableCardListData[52];				//扑克定义
...
public:
	BYTE getOneOtherCardID(BYTE bTempHandCardCount);
};
